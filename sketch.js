...
//find the bug in the below code
   var shrub1 = createSprite(camera.position+500,330,40,10);
   var shrub2 = createSprite (camera.position+500,330,40,10);
   var shrub3 = createSprite(camera.position+500,330,40,10);
   var stone = createSprite(camera.position+500,330,40,10);
